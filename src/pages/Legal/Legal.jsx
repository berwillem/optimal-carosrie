      ...
      <div className="paragraphs">
        <p>
          ...
          <span>
            ...
            utilisateurs et visiteurs du site : Optimale Carrosserie les
            informations suivantes :
          </span>
          <span>
            Informations légales : <br />
            Statut du propriétaire : société par actions <br /> simplifiée
            Préfixe : SAS <br />
        ...
        <p>
          ...
          <span>
            Le site d’ Optimale Carrosserie a pour objet de fournir une
            information concernant l’ensemble des activités de la société. Le
            propriétaire du site s’efforce de fournir sur le site Optimale
            Carrosserie des informations aussi précises que possible. Toutefois,
            il ne pourra être tenue responsable des omissions, des inexactitudes
            et des carences dans la mise à jour, qu’elles soient de son fait ou
            du fait des tiers partenaires qui lui fournissent ces informations.
            Tous les informations proposées sur le site d’Optimale Carrosserie
        ...
        <p>
          ...
          <span>
            Le site Optimale Carrosserie contient un certain nombre de liens
        ...
        <p>
          ...
          <span>
            ...
            Optimale Carrosserie En France, les données personnelles sont
          ...
          <span>
            Sur ce site, le proprietaire du site ne collecte des informations
          ...
          <span>
            ...
            vendue sur un support quelconque à des tiers. Les bases de données
            sont protégées par les dispositions de la loi du 1er juillet 1998
